...
def get_mnist(args, data_dir='C:/Users/user/Desktop/연구실/MNIST/MNIST'):
    """get dataloders"""
...
class TrainerDeepSVDD:
    ...
    def save_weights_for_DeepSVDD(self, model, dataloader):
        ...
        torch.save({'center': c.cpu().data.numpy().tolist(),
                    'net_dict': net.state_dict()}, 'C:/Users/user/Desktop/python/Deep SVDD/pretrained_parameters.pth')
    ...
    def train(self):
        ...
        if self.args.pretrain == True:
            state_dict = torch.load('C:/Users/user/Desktop/python/Deep SVDD/pretrained_parameters.pth')
