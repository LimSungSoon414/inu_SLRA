...
def Convert_Raw_Data(raw_path, save_path, cut_point, total_size, unit=8192, statistics=False):
    # # path setting
...
raw_path = os.path.join(PATH, 'raw_data/2024/6207/N', '600')
save_path = os.path.join(PATH, 'data/2024/6207/600', '7_N')

Convert_Raw_Data(raw_path=raw_path, save_path=save_path, cut_point=10, total_size=50,
                 unit=8192, statistics=False)